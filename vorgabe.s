...
.text
interpolate2:
    la $a1, beispiel_bild_height	# array auf a1
    li $t0, 1				# t0 = 0
    move $t1, $a1			# a1 wir auf t1
    addi $t2, $a1, 4 		# a1 + 4 in t2
loop1:
	#sw $a0, ($t1)			# 
	addi $t1, $t1, 4		# +4
	bne $t1, $t2, loop1		# if t1 != t2 go loop1
...
loop2:
	...
	#addi $v0, $zero, 0      # print_string syscall
