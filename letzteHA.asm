...
interpolate2:
	...
	### Die unten stehende Befehle ergeben immer 0 statt 0x40, 
	### deswegen werde ich davon ausgehen, dass Bilder immer quadratisch 
	### sein werden
    	#la $s1, beispiel_bild_height	#getting the address of height
    	#lw $t4, 0($s1) 	# get the value of the heigt
...
loop2:
	...
	add $t5, $t5, $t3	# Addition von 4 Zahlen
...
interpolate:
	...
	beq $ra, $zero, main
    	...
    	la $a2, n	# We get here the address of n to the $a2
    	lw $t8, ($a2)	# We load the value of the n into the $t8
